class HomesController < ApplicationController
 ...
 # ["bg image for desc","wax image", "desc", "youtube_video_id", "image for after video display", "short discription"]
    @data = [
        ...
        ["/assets/std4.png", "/assets/stdwax4.png", "This distinguishing style looks great on oval faces with hair of short or medium length. Suitable for all thickness and textures, this style sure expresses your individuality!", "bNUrOz3lM5U", "/assets/mohawk.png", "Mohawk", "You always stood out. Now so will your hair."],
        ["/assets/std1.png", "/assets/stdwax1.png", "This seductively sexy style is great for round and oval faces that have medium length hair. Suitable for hair with thin, medium and thick textures, this style gets you adventure ready!", "q8HBIwdtUDM", "/assets/wolver.png", "Wolver", "Like your life, here's a style that's on the edge."],
        ["/assets/std4.png", "/assets/stdwax4.png", "This intensely wild look suits round, oval, and square faces with hair of short or medium length. Suitable for all thickness and textures, all we can say is - Sexy Spikes! Sexy You!", "69ywei5DDQc", "/assets/spikes.png", "Spikes", "Stand-up hair for the Stand-up guy."],
        ["/assets/std3.png", "/assets/stdwax3.png", "This devil-may-care look works for round and oval faces with long hair of medium texture. This style sure glams up your hair!", "OMIu7jQnq-Q", "/assets/glamzone.png", "Glamzone", "You're always on Page 3. Here's a hairstyle on the same page."],  
       ["/assets/std1.png", "/assets/stdwax1.png", "This classy look's great for round and oval faces with long hair of medium or thick texture. Lets you play it cool and classy!", "TRSJOV-mjw0", "/assets/long-crew.png", "Long Crew", "You always dressed the part. Now so will your hair."],
       ["/assets/std2.png", "/assets/stdwax2.png", "This bewitching look suits oval faces with a medium length of hair with thin or medium texture. Get ready to spread the magic with this gripping hairstyle.", "5sq21ezyLbk", "/assets/midnight-cloud.png", "Midnight Cloud", "It's that touch of magic that keeps the night young."],
       ["/assets/std3.png", "/assets/stdwax3.png", "The perfect look for an oval face with long hair of thin to medium texture. Donne this style and you ll be spotlight ready!", "KwVaauEK6Gg", "/assets/stone-wave.png", "Stone Wave", "You always aimed for the stars. So should your hair."],
       ["/assets/std2.png", "/assets/stdwax2.png", "The uber-cool look works for oval or round faces with long hair of medium or thick texture. Wear and it youll definitely step up your style quotient.", "jRYY5btXxpQ", "/assets/graduate.png", "Graduate", "This style separates the men from the boys."],     
       ["/assets/std3.png", "/assets/stdwax3.png", "The perfect office look for round and oval faces that have a medium length of hair with a thin or medium texture. With this style command the attention you deserve.", "LP2UjkqFVeQ", "/assets/shiny-disc.png", "Shiny Disc", "Let your hair be the center of attention too."],
       ["/assets/std2.png", "/assets/stdwax2.png", "The classic look for oval faces with short or medium length hair of medium texture. Makes sure you are smooth and sexy, anytime!", "vsHwWnYwTLs", "/assets/smooth-rider.png", "Smooth Rider", "You are used to having it easy. So does this hairstyle."],
       ["/assets/std1.png", "/assets/stdwax1.png", "The perfect look for round, square and oval faces that has long hair of thin, medium or thick texture. Gets you ready to roll like the king.", "PGnX5TX36Bs", "/assets/elvisy.png", "Elvisy", "Dazzle her with your moves and your hair."]
]
  ...
  def download_ringtone
    ...
    if params[:source].present?
       track_obj.mobile_count = track_obj.mobile_count.to_i + 1
    else
       track_obj.web_count = track_obj.web_count.to_i + 1   
    end  
    track_obj.save
